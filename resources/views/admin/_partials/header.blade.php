<div class="navbar-header">
    ...
    <div class="d-flex">
        ...
        @php
              $id=Auth::User()->id;
              $ProdifleData=app\Models\User::find($id);
        @endphp
        ...
        <div class="dropdown d-inline-block">
            ...
            <div class="dropdown-menu dropdown-menu-end">
                ...
                <a class="dropdown-item" href="{{ route('admin.profile') }}"><i
                        ...
                        key="t-profile">MyProfile</span></a>
                <a class="dropdown-item" href="{{ route('admin.change.password') }}"><i class="align-middle bx bx-wallet font-size-16 me-1"></i>
                ...
                <a class="dropdown-item" href="#"><i
                        class="align-middle bx bx-lock-open font-size-16 me-1"></i> <span key="t-lock-screen">Lock
                        screen</span></a>
