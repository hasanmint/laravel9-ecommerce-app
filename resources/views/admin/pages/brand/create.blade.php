                ...
                <div class="card">
                    <div class="card-body border-bottom">
                        <div class="d-flex align-items-center">
                            <h5 class="mb-0 card-title flex-grow-1">Create Brand</h5>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form method="post" action="{{ route('brand.store') }}" enctype="multipart/form-data">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-10">
                                                <input class="form-control" type="text" name="name"
                                                    placeholder=" Brand Name" id="name">
                                            </div>
                                        </div>
                                        ...
                                        <!--  Brand logo -->
                                        <div class="mb-3 row">
                                            <label for="example-text-input" class="col-sm-2 col-form-label">Brand logo</label>
                                            <div class="col-sm-10">
