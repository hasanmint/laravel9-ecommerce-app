                    ...
                    <div class="card-body border-bottom">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-shrink-0">
                                ...
                                <a href="{{route('category.create')}}" class="btn btn-primary"><i class="align-middle bx bx-plus"></i>
                                    Add New Category</a>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <ul class="gap-1 mb-0 list-unstyled hstack">
                                                            ...
                                                            <li>
                                                                <a href="{{route('category.edit',$category->id)}}" class="btn btn-sm btn-soft-info">
