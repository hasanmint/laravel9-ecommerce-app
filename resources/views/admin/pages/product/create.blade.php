                        ...
                        <div class="col-xl-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="mb-3 row">
                                        <label for="horizontal-email-input" class="col-sm-3 col-form-label">Add More
                                            Image</label>
                                        <div class="col-sm-12">
                                    ...
                                    <div class="mb-3 row">
                                        <label for="horizontal-password-input" class="col-sm-3 col-form-label">Feature
                                            Product</label>
                                        <div class="col-sm-12">
                                    ...
                                    <div class="mb-3 row">
                                        <label for="horizontal-password-input" class="col-sm-3 col-form-label">Today
                                            Deal</label>
                                        <div class="col-sm-12">
                                            <div class="square-switch">
                                                <input type="checkbox" id="square-switch2" switch="info"
                                                    checked="">
