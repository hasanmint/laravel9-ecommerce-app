                    ...
                    <div class="card-body border-bottom">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-shrink-0">
                                ...
                                <a href="{{ route('seo.index') }}" class="btn btn-primary"><i
                                                ...
                                                <div>
                                                    ...
                                                    <div class="mb-4 form-group">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            ...
                                                            placeholder="Enter Meta Verification" value="{{$seo->google_verification}}">
                                                    </div>

                                                    <div class="mb-4 form-group">
                                                        <label for="input-date1">Google Analytics</label>
                                                        <textarea class="form-control" rows="3" name="google_analytics" placeholder="Enter Meta Analytics">{{$seo->google_analytics}}</textarea>
                                                    </div>

                                                    <div class="mb-4 form-group">
                                                        <label for="input-date1">Meta Description</label>
                                                        <textarea class="form-control" rows="3" name="meta_description" placeholder="Enter Meta Description">{{$seo->meta_description}}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <div class="mb-4 form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="meta_keyword"
                                                        placeholder="Enter Meta Keyword"  value="{{$seo->meta_keyword}}">
                                                </div>

                                                <div class="mb-4 form-group">
                                                    <label for="input-date1">Alexa Verification</label>
                                                    <input type="text" class="form-control" name="alexa_verification"
                                                        placeholder="Enter Meta Verification" value="{{$seo->alexa_verification}}" >
                                                </div>

                                                <div class="mb-4 form-group">
                                                    <label for="input-date1">Google Adsense</label>
                                                    <textarea class="form-control" rows="3" name="google_adsense" placeholder="Enter Meta Adsense">{{$seo->google_adsense}}</textarea>
                                                </div>
                                            </div>
