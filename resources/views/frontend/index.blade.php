...
@section('navbar')
@include('frontend._partials.main_nav')
@endsection
                ...
                <div class="deals">
                            ...
                            <div class="owl-item deals_item">
                                ...
                                <div class="deals_content">
                                    <div class="flex-row deals_info_line d-flex justify-content-start">
                                        ...
                                        <div class="ml-auto deals_item_price_a">$300</div>
                                    </div>
                                    <div class="flex-row deals_info_line d-flex justify-content-start">
                                        <div class="deals_item_name">Beoplay H7</div>
                                        <div class="ml-auto deals_item_price">$225</div>
                                    </div>
                                    <div class="available">
                                        <div class="flex-row available_line d-flex justify-content-start">
                                            <div class="available_title">Available: <span>6</span></div>
                                            <div class="ml-auto sold_title">Already sold: <span>28</span></div>
                                        </div>
                                        <div class="available_bar"><span style="width:17%"></span></div>
                                    </div>
                                    <div
                                        class="flex-row deals_timer d-flex align-items-center justify-content-start">
                                        <div class="deals_timer_title_container">
                                            <div class="deals_timer_title">Hurry Up</div>
                                            <div class="deals_timer_subtitle">Offer ends in:</div>
                                        </div>
                                        <div class="ml-auto deals_timer_content">
                                            <div class="clearfix deals_timer_box" data-target-time="">
                    ...
                    <div class="deals_slider_nav_container">
                        <div class="deals_slider_prev deals_slider_nav"><i
                                class="ml-auto fas fa-chevron-left"></i></div>
                        <div class="deals_slider_next deals_slider_nav"><i
                                class="ml-auto fas fa-chevron-right"></i></div>
                    </div>
                </div>
                ...
                <div class="popular_categories_content">
                    ...
                    <div class="popular_categories_slider_nav">
                        <div class="popular_categories_prev popular_categories_nav"><i
                                class="ml-auto fas fa-angle-left"></i></div>
                        <div class="popular_categories_next popular_categories_nav"><i
                                class="ml-auto fas fa-angle-right"></i></div>
                    </div>
...
<div class="new_arrivals">
    <div class="container">
        <div class="row">
            <div class="col">
                <div class="tabbed_container">
                    <div class="clearfix tabs tabs-right">
                            ...
                            <div class="clearfix arrivals_single">
                                <div class="d-flex flex-column align-items-center justify-content-center">
                                    ...
                                    <div class="arrivals_single_content">
                                        ...
                                        <div class="clearfix arrivals_single_name_container">
                                            <div class="arrivals_single_name"><a href="#">LUNA
                                                    Smartphone</a></div>
                                            <div class="text-right arrivals_single_price">$379</div>
                                        </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 advert_col">
                ...
                <div class="flex-row advert d-flex align-items-center justify-content-start">
            ...
            <div class="col-lg-3">
                <div class="trends_container">
                    ...
                    <div class="trends_slider_nav">
                        <div class="trends_prev trends_nav"><i class="ml-auto fas fa-angle-left"></i></div>
                        <div class="trends_next trends_nav"><i class="ml-auto fas fa-angle-right"></i></div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="owl-item">
                            <div class="trends_item is_new">
                                ...
                                <div class="trends_content">
                                    ...
                                    <div class="clearfix trends_info">
        ...
        <div class="row">
            <div class="col">
                ...
                <div class="reviews_title_container">
                    ...
                    <div class="ml-auto reviews_all"><a href="#">view all <span>reviews</span></a>
                    </div>
                </div>
